export default function TaskBar({task, index, deleteTask, editTask}) {
    return (
        <li className='border-b border-gray-300 py-2 flex justify-between items-center'>
              ...
              <div>
                <button 
                  className="mt-2 ml-2 border p-1 rounded-sm border-amber-600 hover:bordr-red-900 hover:bg-amber-600 text-amber-600 hover:text-gray-700 " 
